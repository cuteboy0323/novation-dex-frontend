...
const TokenSelect = ({ open, onClose, onTokenSelect, tokenList, activeToken, target }: any) => {
    ...
    useEffect(() => {
        ...
        (async () => {
            const isExistToken = Object.entries(tokenList).filter(
